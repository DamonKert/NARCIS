...
const GET_CLOTH = "/Clothes";
const CREATE_CLOTH = GET_CLOTH;

const GET_PROVINCE = "/CityProvinces";
const UPDATE_PROVINCE_DELIVERYFEE = (id, data) => (GET_PROVINCE + '/Edit/' + id + "?cost=" + data)

export { HOST, LOGIN, GET_USER, CREATE_USER, UPDATE_USER, GET_USER_BY_ID, GET_MODEL, CREATE_MODEL, UPDATE_MODEL, GET_MODEL_BY_ID, GET_CLOTH, CREATE_CLOTH, GET_PROVINCE, UPDATE_PROVINCE_DELIVERYFEE };