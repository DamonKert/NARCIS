    ...
    return (
        <div className="dropdown">
            ...
            <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                <li role='button' onClick={() => HandleCurrency({ Multiple: 1, Name: "USD $", Symbol: "$" })} className='text-center'>USD $</li>
                <li role='button' onClick={() => HandleCurrency({ Multiple: 4100, Name: "KHR ៛", Symbol: "៛" })} className='text-center'>KHR ៛</li>
            </ul>
        </div>
    )
}
