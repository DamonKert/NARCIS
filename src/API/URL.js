...
const CREATE_CLOTHES = GET_CLOTHES;
const GET_CLOTHES_BY_ID = (id) => (GET_CLOTHES + '/' + id)
const UPDATE_CLOTHES = (id) => (GET_CLOTHES + '/EditCloth/' + id)
const DELETE_CLOTHES_BY_ID = (id) => (GET_CLOTHES + "/" + id)
